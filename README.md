...
test/calcolo.test.js  25 test con il runner integrato di Node
...
## Tre cose non ovvie emerse costruendolo

Sono i punti in cui il dominio si comporta diversamente da come lo si immagina, e per
ognuno c'è un test dedicato che ne blocca il comportamento.

**1. Aumentare la RAL può ridurre il netto.**
L'esenzione dell'addizionale comunale di Milano è una *soglia*, non una franchigia:
superati 23.000 € di imponibile, lo 0,80% si applica sull'intero importo, non solo
sull'eccedenza. Attorno a una RAL di 25.327 € tre euro di lordo in più costano circa
184 € di netto. Non è un artefatto del prototipo, è la norma. Il test
`la soglia comunale ... genera una discontinuità nota` lo verifica esplicitamente, perché
una futura "correzione" non lo faccia sparire per errore.

**2. Le addizionali locali non sono dovute se l'IRPEF netta è zero.**
Facile da dimenticare, perché per le retribuzioni medie l'IRPEF è sempre dovuta e la
regola non si vede mai. Sulle RAL basse, dove le detrazioni azzerano l'imposta, ignorarla
significa trattenere qualche centinaio di euro che non andrebbero trattenuti.

**3. Le formule delle detrazioni si troncano, non si arrotondano.**
...
- **25 test** sul motore di calcolo: unità sulle singole funzioni, comportamento ai confini
  di ogni scaglione e soglia, cinque scenari completi confrontati con i calcoli fatti a mano,
  e proprietà strutturali verificate su tutte le RAL da 0 a 200.000 € a passi di 500 €
  (il netto non è mai negativo, non supera mai il lordo, e RAL = netto + trattenute − integrazioni).
